...
Here the use of color adds *aesthetic appeal*. We do this by placing color in the `geom`etry.
...
Here, we place color in the `aes`thetic so that color adds additional information, i.e. the gender of respondents.
