...
p0 + # basic plot
  geom_bar(stat = "summary", fun.y = "mean") # bars with group means
...
p0 + # basic plot
    geom_bar(aes(fill = group), # bars w/ color fill for group
             stat = "summary", fun.y = "mean") + # bars with group means
  coord_flip() + # flip the plot
  labs(title = "Group B Has The Highest \nMean Outcome", # informative title
       x = "Group", # better axis labels
       y = "Outcome") + 
  scale_fill_brewer(palette = "Set2") + # better color fill scale
...
ggplot(mynewdata, # the data I am using
  ...
  labs(title = "Group B Has The Highest \nMean Outcome", # informative title
       x = "Group", # better axis labels
       y = "Outcome") + 
  scale_color_brewer(palette = "Set2") + # better color scale
  theme_minimal() + # better theme
