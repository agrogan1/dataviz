...
format:
  ...
  pdf:
    ...
    fig-height: 3
prefer-html: true
bibliography: how-to-choose-a-chart-v3.bib
csl: apa.csl
execute: 
  message: false
  warning: false
...
The graphs in these particular examples use [ggplot2](http://ggplot2.org/) [@ggplot2], a graphing library in R. `ggplot2` graph syntax can be formidably complex, with a steep learning curve. More information about ggplot can be found [here](https://agrogan1.github.io/R/introduction-to-ggplot2/introduction-to-ggplot2.html).
...
Graphics made with the ggplot2 [@ggplot2] graphing library created by Hadley Wickham.
